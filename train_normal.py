...
# Bi-LSTM model to train
def train(reload_dataset=False, pretrain_model_path=None, optim_fu='adam', visdom_env='Bi-LSTM'):
    ...
    SAVE_MODEL_PATH = './checkpoint/BiLSTM/'
