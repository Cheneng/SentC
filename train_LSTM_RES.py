...
# 3 layers LSTM model to train
def train_3layers_RES(reload_dataset=False, epoch_num=50, pretrain_model_path=None, optim_fu='adam'):
    ...
    SAVE_MODEL_PATH = './checkpoint/LSTM3LayersRes/'
    VISDOM_ENV = '3-Layers-LSTM-Res'
    PRINT_STEP = 10
    SAVE_STEP = 1
    GPU_NUM = 1
